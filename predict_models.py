...
def hit_predict_dump(predict, test_data, out_path):
    predict_out = []
...
def main(args, log):
    # ["int_tower", "dssm",  "dat", "deep_fm", "dcn", "cold", "auto_int", "wide_and_deep", "hit_tower"]
    ...
    if args.model_name == "hit":
        hit_predict_dump(predict_result, dataSetProcess.test, out_path)
    else:
...
if __name__ == "__main__":
    ...
    # ["int_tower", "dssm",  "dat", "deep_fm", "dcn", "cold", "auto_int", "wide_and_deep", "hit", "kanhit"]
    ...
    parser.add_argument("--ckpt_path", type=str, default="./checkpoints/hit.ckpt")
